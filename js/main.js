...
// GET THE CONDITIONS
weatherConditions.open('GET', 'http://api.openweathermap.org/data/2.5/weather?zip=751001,IN&appid=6fa6e7b21e521ade694abe8e42315af7&units=imperial', true);
...
weatherConditions.onload = function () {
    if (weatherConditions.status === 200) {
        ...
        document.getElementById('desc').innerHTML = "Windspeed " + cObj.wind.speed;
    } //end if
}; //end function

// GET THE FORECARST
//here, for working on non-secured browsers we can remove the http: part and voila!
weatherForecast.open('GET', 'http://api.openweathermap.org/data/2.5/forecast?zip=751001,IN&appid=6fa6e7b21e521ade694abe8e42315af7&units=imperial', true);
